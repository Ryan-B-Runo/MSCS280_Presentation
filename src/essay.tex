...
\begin{document}
    ...
    \begin{theorem}[The Euler Identity~{\cite[pp.~243]{ourBook}}]
    ...
    \begin{theorem}[Wagner's Theorem~{\cite[pp.~260]{ourBook}}]
    ...
    That is, let $\left\{ k, c \in \Z\ \lvert\ 0\leq k<n-1,\ 0<c<n-1-k \right\}$.
